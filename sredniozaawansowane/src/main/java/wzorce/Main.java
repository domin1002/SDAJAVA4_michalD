...
import wzorce.builder.User;
import wzorce.facade.Facade;
import wzorce.factory.Document;
import wzorce.factory.DocumentGenerator;
import wzorce.observer.Person;
import wzorce.observer.Weather;
import wzorce.singleton.DataBase;
import wzorce.startegy.Calculator;
import wzorce.startegy.OperationAdd;
import wzorce.startegy.OperationSubtract;

import java.util.Scanner;

import static wzorce.factory.DocumentGenerator.*;
